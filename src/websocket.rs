...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("rd.iimkk.cn:21115"), "ws://rd.iimkk.cn/ws/id");
        assert_eq!(check_ws("rd.iimkk.cn:21116"), "ws://rd.iimkk.cn/ws/id");
        assert_eq!(check_ws("rd.iimkk.cn:21117"), "ws://rd.iimkk.cn/ws/relay");
        // set relay-server without port
        Config::set_option("relay-server".to_string(), "127.0.0.1".to_string());
        Config::set_option(
            "api-server".to_string(),
            "https://rdapi.iimkk.cn".to_string(),
        );
        assert_eq!(
        ...
        assert_eq!(check_ws("rd.iimkk.cn:21115"), "wss://rd.iimkk.cn/ws/id");
        assert_eq!(check_ws("rd.iimkk.cn:21116"), "wss://rd.iimkk.cn/ws/id");
        assert_eq!(
            check_ws("rd.iimkk.cn:21117"),
            "wss://rd.iimkk.cn/ws/relay"
        );
